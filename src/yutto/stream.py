...
_default_video_download_codec, DEFAULT_VIDEO_SAVE_CODEC = DEFAULT_CONFIG.stream.video_codec.split(":", maxsplit=1)
DEFAULT_VIDEO_DOWNLOAD_CODEC = cast("VideoCodec", _default_video_download_codec)

_default_audio_download_codec, DEFAULT_AUDIO_SAVE_CODEC = DEFAULT_CONFIG.stream.audio_codec.split(":", maxsplit=1)
